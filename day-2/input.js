...
const parsePolicy = (policy) => {
	const bits = policy.split(' ');
	return {
		range: parseRange(bits[0]),
		char: bits[1],
	}
}
...
const parseRange = (range) => {
	...
	return {
		min: parseInt(bits[0], 10),
		max: parseInt(bits[1], 10),
	}
}
...
module.exports = parseEntries(policies);
